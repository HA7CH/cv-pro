      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs">
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-[#FFDD00] px-3 py-1.5 text-sm text-black transition-colors hover:bg-[#FFE533]"
            style={{ fontFamily: "var(--font-cookie)", fontSize: "16px", lineHeight: 1 }}
          >
            <svg className="h-4 w-auto" viewBox="0 0 884 1279" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
